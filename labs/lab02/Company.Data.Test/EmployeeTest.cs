...
namespace Company.Data.Test
{
    ...
    public class EmployeeTest
    {
        ...
        [Test, TestCaseSource("InactiveEmployees")]
        public void Given_Employee_Then_SalutationReturnsAccordingToType(Employee employee)
        {
            string actual = "Hello " + employee.GetType().Name + " " + employee.GetFullName();
            string expected = employee.Salutation();
